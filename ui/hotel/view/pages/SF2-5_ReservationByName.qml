...
Content {
    ...
    function updateNextButtonState() {
        const filled = field_sei.text.length > 0 && field_mei.text.length > 0
    ...
    KeyboardPopup {
     ...
     MainContent {
        ...
        TitleText {
            ...
            text: qsTrr("ご予約の時のお名前をフルネーム（カナ名）\nで入力してください")
        }
        ...
        Row {
            ...
            anchors {
                ...
                top: _titleText.bottom;topMargin: 70
            }
            spacing: 70
            ...
            Rectangle {
                ...
                DefaultTextField {
                    ...
                    width: parent.width
                    height: parent.height
                    placeholderText: qsTrr("タッチしてカタカナ入力")
                    font.pixelSize: 40
